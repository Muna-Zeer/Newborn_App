...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('MotherExaminations', function (Blueprint $table) {
            ...
            $table->String('weeks_of_pregnancy')->nullable();
            $table->enum('method_of_delivery', ['Normal', 'Vaccum', 'Forceps', 'C_S']);
            ...
            $table->boolean('First_born')->nullable();
            $table->boolean('BP_Status')->nullable();
            $table->integer('Mother_weight')->nullable();
            $table->integer('Strong_of_blood')->nullable();
