...
class Newborn extends Model
{
    ...
    protected $fillable = [
        ...
        'status', 'delivery_method', 'location_id', 'health_center_id', 'hospital_center_id',  'measurement_id', 'ministry_center_id', 'doctor_id', 'nurse_id', 'midwife_id', 'newborn_hospital_nursery_id'
    ];
