...
class NewbornController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $newborn->mother_id = $mother ? $mother->identity_number : null;
        $newborn->health_center_id = $request->input('health_center_id');
        // $newborn->hospital_center_id = $request->input('hospital_center_id');
        $newborn->measurement_id = $request->input('measurement_id');
        // $newborn->ministry_center_id = $request->input('ministry_center_id');
