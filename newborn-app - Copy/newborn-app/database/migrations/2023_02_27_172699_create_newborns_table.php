...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('newborns', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('vaccination_table_id')->nullable(); // Foreign key column
            // $table->foreign('vaccination_table_id')->references('id')->on('VaccinationTables')->onDelete('set null');
