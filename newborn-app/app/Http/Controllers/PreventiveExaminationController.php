...
class PreventiveExaminationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'ministry_id' => 'nullable|integer|exists:ministry_of_health,id',
        ...
        $preventiveExamination->hospital_id = $request->input('hospital_id');
        ...
        $preventiveExamination = PreventiveExamination::with(['newborn', 'hospital', 'healthCenter', 'ministry', 'nurse'])->findOrFail($preventiveExamination->id);
        return response()->json([
            'status' => 'success',
