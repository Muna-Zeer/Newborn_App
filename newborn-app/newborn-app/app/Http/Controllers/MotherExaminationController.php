...
class MotherExaminationController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            // 'time_of_delivery' => 'nullable|date_format:H:i A',
            ...
            'midwife_name' => 'nullable|string|max:255',
        ...
        $motherExamination->BP_Status = $request->input('BP_Status');
          ...
          if ($doctorName) {
              ...
              if (!$doctor) {
                  // return response()->json(['errors' => 'Invalid doctor Name'], 422);
                  $doctor = new Doctor();
